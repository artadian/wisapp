...
// var db;
//var realm;
class Eprop_NeedApprovalScreen extends Component {
    ...
    componentWillMount() {
        ...
        //.fetch('GET','https://eprop.wim-bms.com/mobilews.asmx/ToApprove1012?signer='+ r.id)
        ...
        //.fetch('GET','https://eprop.wim-bms.com/mobilews.asmx/Sent?id=91' )
        .then(async(resp)=>{
            ...
            <View style={styles.modalContent}>
                <ScrollView style={{height:height-150}}>    
                    ...
                    <Input
                        label='NOMOR NOTULEN'
                        width={260}
                        onChangeText={(text) => this.setState({nonotulen:text})}
                        value={this.state.nonotulen}
                    />
    ...
    render() {
        ...
        <View style={styles.container}>
            ...
            <Header
                ...
                centerComponent={{ text: 'Need Approval', style: { color: 'white' } }}
...
export default Eprop_NeedApprovalScreen;