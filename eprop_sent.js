...
// var db;
//var realm;
class Eprop_SentScreen extends Component {
    ...
    componentWillMount() {
        ...
        .fetch('GET','https://eprop.wim-bms.com/mobilews.asmx/Sent?id=' + r.id )
        .then(async(resp)=>{
    ...
    render() {
        ...
        <View style={styles.container}>
            ...
            <Header
                ...
                centerComponent={{ text: 'SENT', style: { color: 'white' } }}
...
export default Eprop_SentScreen;