...
// var db;
//var realm;
class Edoc_SentScreen extends Component {
    ...
    componentWillMount() {
        ...
        .config({trusty:true,})
        .fetch('GET','https://edoc.wim-bms.com/mobilews.asmx/Sent?id=' + r.id )
        .then(async(resp)=>{
    ...
    render() {
        ...
        <View style={styles.container}>
            ...
            <Header
                ...
                centerComponent={{ text: 'Sent', style: { color: 'white',fontSize:25 } }}
...
export default Edoc_SentScreen;